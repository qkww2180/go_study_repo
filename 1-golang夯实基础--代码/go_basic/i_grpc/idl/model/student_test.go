...
// go test -v ./i_grpc/idl/model -run=^TestStudentSerialize$ -count=1
// go test ./i_grpc/idl/model -bench=^Benchmark -run=^$ -count=1 -benchmem
/*
goos: windows
goarch: amd64
pkg: dqq/go/basic/i_grpc/idl/model
